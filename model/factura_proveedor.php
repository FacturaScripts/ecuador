...
class factura_proveedor extends fs_model
{
   ...
   {
      parent::__construct('facturasprov', 'plugins/ecuador/');
      if($f)
      {
      ...
      if( $this->test() )
      {
         if( $this->exists() )
         {
            $sql = "UPDATE ".$this->table_name." SET codigo = ".$this->var2str($this->codigo)
                    ...
                    .", codsustento = ".$this->var2str($this->codsustento)                    
         ...
         else
         {
            ...
            $sql = "INSERT INTO ".$this->table_name." (codigo,total,neto,cifnif,pagada,observaciones,
               ...
               totalrecargo,fecha,hora,codsustento) VALUES (".$this->var2str($this->codigo)
