 ...
 */
/**
 * Validador de tipos de identificación
 */
require_once 'plugins/ecuador/extras/validador.php';
...
class empresa extends fs_model
{
   ...
   public function test()
   {
      ...
      else if(!$validador->valida_id($this->cifnif))
      {
         $this->new_error_msg("Identificador de empresa no es válido.");
      }
      else
      {
         $status = TRUE;
